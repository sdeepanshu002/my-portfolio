const SocialLinks = () => {
  return (
    <div className="flex flex-wrap gap-6 justify-center mt-6 text-xl">
      <a href="https://www.linkedin.com/in/deepanshu-sharma-241202ds" target="_blank" rel="noreferrer" className="hover:text-blue-600">🔗 LinkedIn</a>
      <a href="https://www.instagram.com/deepanshu_sharma24?igsh=MWlzNWgzYnJ2NnBmZw==" target="_blank" rel="noreferrer" className="hover:text-blue-600">🔗 Instagram</a>
